...
exports.LlamaChatSession = void 0;
const config_js_1 = require("../config.js");
const withLock_js_1 = require("../utils/withLock.js");
...
const generateContextTextFromConversationHistory_js_1 = require("../chatWrappers/generateContextTextFromConversationHistory.js");
const removeNullFields_js_1 = require("../utils/removeNullFields.js");
const LlamaModel_js_1 = require("./LlamaModel.js");
const LlamaGrammarEvaluationState_js_1 = require("./LlamaGrammarEvaluationState.js");
...
class LlamaChatSession {
     ...
     */
    constructor({ context, printLLamaSystemInfo = false, promptWrapper = new GeneralChatPromptWrapper_js_1.GeneralChatPromptWrapper(), systemPrompt = config_js_1.defaultChatSystemPrompt, conversationHistory }) {
        this._ctx = context;
        ...
        if (promptWrapper === "auto") {
            const chatWrapper = (0, createChatWrapperByBos_js_1.getChatWrapperByBos)(context.getBosString());
            if (chatWrapper != null)
                this._promptWrapper = new chatWrapper();
            else
                this._promptWrapper = new GeneralChatPromptWrapper_js_1.GeneralChatPromptWrapper();
        }
        else
    ...
    async init() {
        await (0, withLock_js_1.withLock)(this, "init", async () => {
            if (this._initialized)
                return;
            if (this._printLLamaSystemInfo)
                console.log("Llama system info", LlamaModel_js_1.LlamaModel.systemInfo);
    ...
    async promptWithMeta(prompt, { onToken, signal, maxTokens, temperature, topK, topP, grammar = this.context._chatGrammar, trimWhitespaceSuffix = false, repeatPenalty } = {}) {
        if (!this.initialized)
            await this.init();
        return await (0, withLock_js_1.withLock)(this, "prompt", async () => {
            let promptText = "";
            if (this._promptIndex == 0 && this._conversationHistoryToLoad != null) {
                const { text, stopString, stopStringSuffix } = (0, generateContextTextFromConversationHistory_js_1.generateContextTextFromConversationHistory)(this._promptWrapper, this._conversationHistoryToLoad, {
    ...
    async _evalTokens(tokens, { onToken, signal, maxTokens, temperature, topK, topP, grammar = this.context._chatGrammar, trimWhitespaceSuffix = false, repeatPenalty: { lastTokens: repeatPenaltyLastTokens = 64, punishTokensFilter, penalizeNewLine, penalty, frequencyPenalty, presencePenalty } = {} } = {}) {
        ...
        const grammarEvaluationState = grammar != null
            ? new LlamaGrammarEvaluationState_js_1.LlamaGrammarEvaluationState({ grammar })
            : undefined;
        ...
        const evaluationIterator = this._ctx.evaluate(tokens, (0, removeNullFields_js_1.removeNullFields)({
...
exports.LlamaChatSession = LlamaChatSession;
